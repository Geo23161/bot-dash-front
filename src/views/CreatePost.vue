                    ...
                    <div style="padding: 2rem 0rem;">
                        <div class="d_sp">
                            ...
                            <select class="my_inp" placeholder="cliquez ici..." v-model="goal">
                                ...
                                <option value="paiement"> Enregistrer ses informations 
                                </option>
                                <option value="event"> Rediriger vers la page de paiement
                                </option>
                            </select>
                        </div>
...
const to_next = () => {
    if (stp.value == 0) {
        ...
        try {
            ...
            else mont.value = (price - amount.value), create_compaign();
            // , yOpen.value = true, console.log(`price : ${budget.value}`);
        } catch (e) {
